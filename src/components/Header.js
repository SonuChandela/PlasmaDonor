        ...
        return(
          ...
          {/* modal close  */}
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <NavLink to="/" className="nav-link text-uppercase" activeStyle={{color:"#2a81ea"}}>Home</NavLink>
                <NavLink to="/list/request" className="nav-link text-uppercase"  activeStyle={{color:"#2a81ea"}}>Request List</NavLink>
                <NavLink to="/list/donor" className="nav-link text-uppercase"  activeStyle={{color:"#2a81ea"}}>Donor List</NavLink>
